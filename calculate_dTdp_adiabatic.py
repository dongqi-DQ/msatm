...
def calculate_dTdp_adiabatic(T,rt,p,varargin):
    """
    ...
    rv,rl,ri,rs = saturation_adjustment(p,T,rt,varargin[1:])
    ...
    desdT,junk1,junk2 = desatdT(T[sat],varargin[1:])
    junk1,fice,[dfliqdT,junk2] = calculate_frac_ice(T[sat],varargin[1:])
